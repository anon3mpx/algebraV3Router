...
import {
  ...
  Currency as Currency$1,
  TradeType as TradeType$1,
  Price,
...
declare const isStableSwapSupported: (
...
declare function getLPOutputWithoutFee(
  params: Omit<GetLPOutputParams, "fee">
...
declare function getSwapOutput({
  amplifier,
...
declare function getSwapOutputWithoutFee(
  params: Omit<GetSwapOutputParams, "fee">
): CurrencyAmount<Currency>;
declare function getSwapInput({
  amount,
  ...rest
}: GetSwapOutputParams): CurrencyAmount<Currency>;
declare function getSwapInputWithtouFee(
  params: Omit<GetSwapOutputParams, "fee">
): CurrencyAmount<Currency>;
...
declare const getCheckAgainstBaseTokens: ((
  currencyA?: Currency,
  currencyB?: Currency
) => Token[]) &
  lodash.MemoizedFunction;
declare const getPairCombinations: ((
  currencyA?: Currency,
  currencyB?: Currency
) => [Currency, Currency][]) &
  lodash.MemoizedFunction;
...
type RouteWithoutGasEstimate = Omit<
  RouteWithQuote,
...
interface GasModel {
  estimateGasCost: (
    route: RouteWithoutGasEstimate,
    info: GasEstimateRequiredInfo
  ) => GasCost;
}
...
declare function getBestTrade(
  amount: CurrencyAmount<Currency> | CurrencyAmount$1<Currency$1>,
...
declare function createHybridPoolProvider({
  onChainProvider,
  v2SubgraphProvider,
  v3SubgraphProvider,
}: HybridPoolProviderConfig): PoolProvider;

declare const getV2PoolsOnChain: (
  pairs: [Currency, Currency][],
  provider?: OnChainProvider,
  blockNumber?: BigintIsh
) => Promise<(V2Pool | StablePool)[]>;
declare const getV3PoolsWithoutTicksOnChain: (
  pairs: [Currency, Currency][],
  provider?: OnChainProvider,
  blockNumber?: BigintIsh
) => Promise<V3Pool[]>;
...
declare const getV3PoolSubgraph: ({
  provider,
  pairs,
}: {
...
declare const getV2PoolSubgraph: ({
  provider,
  pairs,
}: {
  provider?: SubgraphProvider | undefined;
...
declare const getAllV3PoolsFromSubgraph: ({
  provider,
  chainId,
  pageSize,
}: {
...
declare const v3PoolTvlSelector: (
  currencyA: Currency | undefined,
  currencyB: Currency | undefined,
  unorderedPoolsWithTvl: V3PoolWithTvl[]
) => Omit<V3PoolWithTvl, "tvlUSD">[];
declare const v2PoolTvlSelector: (
  currencyA: Currency | undefined,
  currencyB: Currency | undefined,
  unorderedPoolsWithTvl: V2PoolWithTvl[]
) => Omit<V2PoolWithTvl, "tvlUSD">[];
...
type GetTokenPrices<T> = (
  params: {
    addresses: string[];
    chainId?: ChainId;
  } & T
) => Promise<TokenUsdPrice[]>;
type CommonTokenPriceProvider<T> = (
  params: GetCommonTokenPricesParams & T
) => Promise<Map<Address, number> | null>;
declare function createCommonTokenPriceProvider<T = any>(
...
declare const getCommonTokenPrices: (
  args_0: ParamsWithFallback
) => Promise<any>;
...
declare function createV2PoolsProviderByCommonTokenPrices<T = any>(
  getCommonTokenPrices: CommonTokenPriceProvider<T>
): ({
  currencyA,
  currencyB,
  pairs: providedPairs,
  ...
  blockNumber,
  ...rest
}: GetV2PoolsParams & T) => Promise<(V2PoolWithTvl | StablePoolWithTvl)[]>;
declare const getV2PoolsWithTvlByCommonTokenPrices: ({
  currencyA,
  currencyB,
  pairs: providedPairs,
  onChainProvider,
...
type GetV2Pools<T = any> = (
  params: GetV2PoolsParams & T
) => Promise<(V2PoolWithTvl | StablePoolWithTvl)[]>;
declare function createGetV2CandidatePools<T = any>(
  defaultGetV2Pools: GetV2Pools<T>,
  options?: WithFallbackOptions<GetV2Pools<T>>
): (params: GetV2PoolsParams & T) => Promise<Omit<V2PoolWithTvl, "tvlUSD">[]>;
declare function getV2CandidatePools(
  params: Params
): Promise<Omit<V2PoolWithTvl, "tvlUSD">[]>;
...
declare const v3PoolsOnChainProviderFactory: <
  P extends GetV3PoolsParams = GetV3PoolsParams
>(
  tvlReferenceProvider: (params: P) => Promise<V3PoolTvlReference[]>
) => (params: P) => Promise<V3PoolWithTvl[]>;
declare const getV3PoolsWithTvlFromOnChain: (
  params: GetV3PoolsParams
) => Promise<V3PoolWithTvl[]>;
declare const getV3PoolsWithTvlFromOnChainFallback: (
  params: GetV3PoolsParams
) => Promise<V3PoolWithTvl[]>;
declare const getV3PoolsWithTvlFromOnChainStaticFallback: (
  params: Omit<GetV3PoolsParams, "onChainProvider" | "subgraphProvider">
) => Promise<V3PoolWithTvl[]>;
type GetV3Pools<T = any> = (
  params: GetV3PoolsParams & T
) => Promise<V3PoolWithTvl[]>;

declare function createGetV3CandidatePools<T = any>(
  defaultGetV3Pools: GetV3Pools<T>,
  options?: WithFallbackOptions<GetV3Pools<T>>
): (params: GetV3PoolsParams & T) => Promise<Omit<V3PoolWithTvl, "tvlUSD">[]>;
declare function getV3CandidatePools(
  params: DefaultParams
): Promise<Omit<V3PoolWithTvl, "tvlUSD">[]>;
...
declare function getCandidatePools({
  protocols,
  v2SubgraphProvider,
  v3SubgraphProvider,
  ...rest
...
declare function createPoolProvider(
  config: HybridPoolProviderConfig
): PoolProvider;

declare function createQuoteProvider(
  config: QuoterConfig
): QuoteProvider<QuoterConfig>;
...
declare const publicClient: {
  84532: {
    ...
    transport: viem.TransportConfig<string, viem.EIP1193RequestFn> &
      Record<string, any>;
    type: string;
    uid: string;
    call: (
      parameters: viem.CallParameters<viem.Chain | undefined>
    ...
    createContractEventFilter: <
      const TAbi extends viem.Abi | readonly unknown[],
      TEventName extends string | undefined,
      TArgs extends
        | viem__types_types_contract.MaybeExtractEventArgsFromAbi<
            TAbi,
            TEventName
          >
        | undefined,
      TStrict extends boolean | undefined = undefined,
      TFromBlock extends bigint | viem.BlockTag | undefined = undefined,
      TToBlock extends bigint | viem.BlockTag | undefined = undefined
    >(
      args: viem.CreateContractEventFilterParameters<
        TAbi,
        TEventName,
        TArgs,
        TStrict,
      ...
      viem.CreateContractEventFilterReturnType<
        TAbi,
        TEventName,
        TArgs,
        TStrict,
    ...
    >;
    createEventFilter: <
      const TAbiEvent extends abitype.AbiEvent | undefined = undefined,
      const TAbiEvents extends
        | readonly unknown[]
        | readonly abitype.AbiEvent[]
        | undefined = TAbiEvent extends abitype.AbiEvent
        ? [TAbiEvent]
        : undefined,
      TStrict_1 extends boolean | undefined = undefined,
      TFromBlock_1 extends bigint | viem.BlockTag | undefined = undefined,
      TToBlock_1 extends bigint | viem.BlockTag | undefined = undefined,
      _EventName extends
        | string
        | undefined = viem__types_types_contract.MaybeAbiEventName<TAbiEvent>,
      _Args extends
        | viem__types_types_contract.MaybeExtractEventArgsFromAbi<
            TAbiEvents,
            _EventName
    ...
    >(
      args?:
        | viem.CreateEventFilterParameters<
            TAbiEvent,
            TAbiEvents,
            TStrict_1,
            TFromBlock_1,
    ...
    estimateContractGas: <
      TChain extends viem.Chain | undefined,
      const TAbi_1 extends viem.Abi | readonly unknown[],
    ...
    estimateGas: (
      args: viem.EstimateGasParameters<
    ...
    getBlock: <
      ...
      TBlockTag extends viem.BlockTag = "latest"
    >(
      args?:
        | viem.GetBlockParameters<TIncludeTransactions, TBlockTag>
        | undefined
    ) => Promise<
      viem.GetBlockReturnType<
        viem.Chain | undefined,
    ...
    >;
    getBlockNumber: (
      args?: viem.GetBlockNumberParameters | undefined
    ) => Promise<bigint>;
    getBlockTransactionCount: (
      args?: viem.GetBlockTransactionCountParameters | undefined
    ) => Promise<number>;
    getBytecode: (
      args: viem.GetBytecodeParameters
    ) => Promise<viem.GetBytecodeReturnType>;
    getChainId: () => Promise<number>;
    getContractEvents: <
      const TAbi_2 extends viem.Abi | readonly unknown[],
      TEventName_1 extends string | undefined = undefined,
      TStrict_2 extends boolean | undefined = undefined,
      TFromBlock_2 extends bigint | viem.BlockTag | undefined = undefined,
      TToBlock_2 extends bigint | viem.BlockTag | undefined = undefined
    >(
      args: viem__types_actions_public_getContractEvents.GetContractEventsParameters<
        TAbi_2,
        TEventName_1,
        TStrict_2,
        TFromBlock_2,
      ...
      viem__types_actions_public_getContractEvents.GetContractEventsReturnType<
        TAbi_2,
        TEventName_1,
        TStrict_2,
        TFromBlock_2,
    ...
    getFeeHistory: (
      args: viem.GetFeeHistoryParameters
    ) => Promise<viem.GetFeeHistoryReturnType>;
    estimateFeesPerGas: <
      TChainOverride extends viem.Chain | undefined = undefined,
      TType extends viem.FeeValuesType = "eip1559"
    >(
      args?:
        | viem.EstimateFeesPerGasParameters<
            viem.Chain | undefined,
            TChainOverride,
            TType
          >
        | undefined
    ) => Promise<viem.EstimateFeesPerGasReturnType>;
    getFilterChanges: <
      TFilterType extends viem__types_types_filter.FilterType,
      const TAbi_3 extends viem.Abi | readonly unknown[] | undefined,
      TEventName_2 extends string | undefined,
      TStrict_3 extends boolean | undefined = undefined,
      TFromBlock_3 extends bigint | viem.BlockTag | undefined = undefined,
      TToBlock_3 extends bigint | viem.BlockTag | undefined = undefined
    >(
      args: viem.GetFilterChangesParameters<
        TFilterType,
        TAbi_3,
        TEventName_2,
        TStrict_3,
      ...
      viem.GetFilterChangesReturnType<
        TFilterType,
        TAbi_3,
        TEventName_2,
        TStrict_3,
    ...
    >;
    getFilterLogs: <
      const TAbi_4 extends viem.Abi | readonly unknown[] | undefined,
      TEventName_3 extends string | undefined,
      TStrict_4 extends boolean | undefined = undefined,
      TFromBlock_4 extends bigint | viem.BlockTag | undefined = undefined,
      TToBlock_4 extends bigint | viem.BlockTag | undefined = undefined
    >(
      args: viem.GetFilterLogsParameters<
        TAbi_4,
        TEventName_3,
        TStrict_4,
        TFromBlock_4,
    ...
    getLogs: <
      const TAbiEvent_1 extends abitype.AbiEvent | undefined = undefined,
      const TAbiEvents_1 extends
        | readonly unknown[]
        | readonly abitype.AbiEvent[]
        | undefined = TAbiEvent_1 extends abitype.AbiEvent
        ? [TAbiEvent_1]
        : undefined,
      TStrict_5 extends boolean | undefined = undefined,
      TFromBlock_5 extends bigint | viem.BlockTag | undefined = undefined,
      TToBlock_5 extends bigint | viem.BlockTag | undefined = undefined
    >(
      args?:
        | viem.GetLogsParameters<
            TAbiEvent_1,
            TAbiEvents_1,
            TStrict_5,
            TFromBlock_5,
    ...
    >;
    getProof: (
      args: viem__types_actions_public_getProof.GetProofParameters
    ) => Promise<viem__types_actions_public_getProof.GetProofReturnType>;
    estimateMaxPriorityFeePerGas: <
      TChainOverride_1 extends viem.Chain | undefined = undefined
    >(
      args?:
        | {
    ...
    getStorageAt: (
      args: viem.GetStorageAtParameters
    ) => Promise<viem.GetStorageAtReturnType>;
    getTransaction: <TBlockTag_1 extends viem.BlockTag = "latest">(
      args: viem.GetTransactionParameters<TBlockTag_1>
    ) => Promise<
      viem.GetTransactionReturnType<viem.Chain | undefined, TBlockTag_1>
    >;
    getTransactionConfirmations: (
      args: viem.GetTransactionConfirmationsParameters<viem.Chain | undefined>
    ) => Promise<bigint>;
    getTransactionCount: (
      args: viem.GetTransactionCountParameters
    ) => Promise<number>;
    getTransactionReceipt: (
      args: viem.GetTransactionReceiptParameters
    ) => Promise<viem.TransactionReceipt>;
    multicall: <
      TContracts extends viem.ContractFunctionConfig[],
      TAllowFailure extends boolean = true
    >(
      args: viem.MulticallParameters<TContracts, TAllowFailure>
    ) => Promise<viem.MulticallReturnType<TContracts, TAllowFailure>>;
    prepareTransactionRequest: <
      TChainOverride_2 extends viem.Chain | undefined = undefined
    >(
    ...
    readContract: <
      const TAbi_5 extends viem.Abi | readonly unknown[],
      TFunctionName_1 extends string
    >(
      args: viem.ReadContractParameters<TAbi_5, TFunctionName_1>
    ) => Promise<viem.ReadContractReturnType<TAbi_5, TFunctionName_1>>;
    sendRawTransaction: (
      args: viem__types_actions_wallet_sendRawTransaction.SendRawTransactionParameters
    ) => Promise<`0x${string}`>;
    simulateContract: <
      const TAbi_6 extends viem.Abi | readonly unknown[],
      TFunctionName_2 extends string,
      TChainOverride_3 extends viem.Chain | undefined = undefined
    >(
      args: viem.SimulateContractParameters<
        TAbi_6,
        TFunctionName_2,
        viem.Chain | undefined,
        TChainOverride_3
      ...
      viem.SimulateContractReturnType<
        TAbi_6,
        TFunctionName_2,
        viem.Chain | undefined,
        TChainOverride_3
    ...
    >;
    verifyMessage: (
      args: viem__types_actions_public_verifyMessage.VerifyMessageParameters
    ) => Promise<boolean>;
    verifyTypedData: (
      args: viem__types_actions_public_verifyTypedData.VerifyTypedDataParameters
    ) => Promise<boolean>;
    uninstallFilter: (args: viem.UninstallFilterParameters) => Promise<boolean>;
    waitForTransactionReceipt: (
      args: viem.WaitForTransactionReceiptParameters<viem.Chain | undefined>
    ) => Promise<viem.TransactionReceipt>;
    watchBlockNumber: (
      args: viem.WatchBlockNumberParameters
    ) => viem.WatchBlockNumberReturnType;
    watchBlocks: <
      TIncludeTransactions_1 extends boolean = false,
      TBlockTag_2 extends viem.BlockTag = "latest"
    >(
      args: viem.WatchBlocksParameters<
        viem.Transport,
        viem.Chain | undefined,
        TIncludeTransactions_1,
        TBlockTag_2
      >
    ) => viem.WatchBlocksReturnType;
    watchContractEvent: <
      const TAbi_7 extends viem.Abi | readonly unknown[],
      TEventName_4 extends string,
      TStrict_6 extends boolean | undefined = undefined
    >(
      args: viem.WatchContractEventParameters<TAbi_7, TEventName_4, TStrict_6>
    ) => viem.WatchContractEventReturnType;
    watchEvent: <
      const TAbiEvent_2 extends abitype.AbiEvent | undefined = undefined,
      const TAbiEvents_2 extends
        | readonly unknown[]
        | readonly abitype.AbiEvent[]
        | undefined = TAbiEvent_2 extends abitype.AbiEvent
        ? [TAbiEvent_2]
        : undefined,
      TStrict_7 extends boolean | undefined = undefined
    >(
      args: viem.WatchEventParameters<TAbiEvent_2, TAbiEvents_2, TStrict_7>
    ) => viem.WatchEventReturnType;
    watchPendingTransactions: (
      args: viem.WatchPendingTransactionsParameters<viem.Transport>
    ) => viem.WatchPendingTransactionsReturnType;
    extend: <
      const client extends {
        ...
        Pick<
          ...
          | "watchContractEvent"
        > &
          Pick<viem.WalletActions, "sendTransaction" | "writeContract">
      >
    >(
      fn: (
        client: viem.Client<
          ...
          viem.Chain | undefined,
          undefined,
          viem.PublicRpcSchema,
          viem.PublicActions<viem.Transport, viem.Chain | undefined>
        >
      ) => client
    ) => viem.Client<
      viem.Transport,
      ...
      undefined,
      viem.PublicRpcSchema,
      { [K_1 in keyof client]: client[K_1] } & viem.PublicActions<
        viem.Transport,
        viem.Chain | undefined
      >
    >;
...
declare const zPools: z.ZodArray<
  z.ZodUnion<
    [
      z.ZodObject<
        {
...
declare const zRouterGetParams: z.ZodObject<
  {
    ...
    >;
    poolTypes: z.ZodOptional<
      z.ZodArray<z.ZodNativeEnum<typeof PoolType>, "many">
    >;
  },
  "strip",
  z.ZodTypeAny,
...
declare function getExecutionPrice(
  trade: SmartRouterTrade<TradeType$1> | null | undefined
): Price<
  _cryptoalgebra_custom_pools_sdk.Currency,
  _cryptoalgebra_custom_pools_sdk.Currency
> | null;
...
declare function maximumAmountIn(
  trade: SmartRouterTrade<TradeType>,
  slippage: Percent$1,
  amountIn?: CurrencyAmount$1<_cryptoalgebra_custom_pools_sdk.Currency>
): CurrencyAmount$1<_cryptoalgebra_custom_pools_sdk.Currency>;
declare function minimumAmountOut(
  trade: SmartRouterTrade<TradeType>,
  slippage: Percent$1,
  amountOut?: CurrencyAmount$1<_cryptoalgebra_custom_pools_sdk.Currency>
): CurrencyAmount$1<_cryptoalgebra_custom_pools_sdk.Currency>;

declare function computePairAddress(
  token0: Token$1,
  token1: Token$1,
  isStable: boolean
): `0x${string}`;
...
declare function getMidPrice({
  path,
  pools,
}: Route): Price$1<Currency, Currency>;

declare function getPriceImpact(
  trade: SmartRouterTrade<TradeType$1>
): Percent$1;
...
interface SerializedStablePool
  extends Omit<StablePool, "reserve0" | "reserve1"> {
  reserve0: SerializedCurrencyAmount;
  reserve1: SerializedCurrencyAmount;
}
...
interface SerializedRoute
  extends Omit<
    Route,
    "pools" | "path" | "input" | "output" | "inputAmount" | "outputAmount"
  > {
...
declare function serializeCurrencyAmount(
  amount: CurrencyAmount<Currency>
...
declare function serializeTrade(
  trade: SmartRouterTrade<TradeType>
): SerializedTrade;
declare function parseCurrency(
  chainId: ChainId,
  currency: SerializedCurrency
): Currency;
declare function parseCurrencyAmount(
  chainId: ChainId,
...
export {
  ...
  TokenSpecificPoolSelectorConfig,
  TradeConfig,
  transformer as Transformer,
  V2Pool,
  V2PoolWithTvl,

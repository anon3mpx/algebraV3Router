...
export declare const V3_SUBGRAPHS: {
    readonly 84532: "https://api.studio.thegraph.com/query/50593/integral-v12/v1.0.0";
};
export declare const V2_SUBGRAPHS: {};
export declare const BLOCKS_SUBGRAPHS: {
    readonly 84532: "https://api.studio.thegraph.com/query/50593/base-testnet-blocks/version/latest";
};

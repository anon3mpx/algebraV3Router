...
export declare const quoteProvider: {
    84532: import("../types").QuoteProvider<import("../types").QuoterConfig>;
};
export declare const v3SubgraphClient: {
    84532: GraphQLClient;
};
export declare const v2SubgraphClient: {
    84532: GraphQLClient;
};
//# sourceMappingURL=publicProviders.d.ts.map